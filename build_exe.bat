...
python -m PyInstaller --add-data "vendor;vendor" --add-data "data;data" --add-data "images;images" --name "%exe_name%_%app_version%_unpacked" --noupx -i ./images/automated-video-testing-header-icon.ico ./automated_cases.py